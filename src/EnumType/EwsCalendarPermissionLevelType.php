...
class EwsCalendarPermissionLevelType
{
     ...
     */
    const VALUE_FREEBUSYTIMEONLY = 'FreeBusyTimeOnly';
    /**
     * Constant for value 'FreeBusyTimeAndSubjectAndLocation'
     * @return string 'FreeBusyTimeAndSubjectAndLocation'
     */
    const VALUE_FREEBUSYTIMEANDSUBJECTANDLOCATION = 'FreeBusyTimeAndSubjectAndLocation';
    /**
     ...
     * @uses self::VALUE_FREEBUSYTIMEONLY
     * @uses self::VALUE_FREEBUSYTIMEANDSUBJECTANDLOCATION
    ...
    public static function getValidValues()
    {
        return array(
            ...
            self::VALUE_FREEBUSYTIMEONLY,
            self::VALUE_FREEBUSYTIMEANDSUBJECTANDLOCATION,
            self::VALUE_CUSTOM,
        );
    }
    /**
