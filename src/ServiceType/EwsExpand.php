...
/**
 * This class stands for Expand ServiceType
 * @package Ews
 * @subpackage Services
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class EwsExpand extends SoapClientBase
{
    /**
     ...
     * @param \StructType\EwsExpandDLType $request
     * @return \StructType\EwsExpandDLResponseType|bool
     */
    public function ExpandDL(\StructType\EwsExpandDLType $request)
    {
        try {
            $this->setResult($resultExpandDL = $this->getSoapClient()->__soapCall('ExpandDL', [
                $request,
            ], [], [], $this->outputHeaders));
        
            return $resultExpandDL;
     ...
     * @return \StructType\EwsExpandDLResponseType
     */
