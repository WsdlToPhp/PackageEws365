...
class EwsPlay extends SoapClientBase
{
     ...
     * @param \StructType\EwsPlayOnPhoneType $request
     * @return \StructType\EwsPlayOnPhoneResponseMessageType|bool
     */
    public function PlayOnPhone(\StructType\EwsPlayOnPhoneType $request)
    {
        try {
            $this->setResult($resultPlayOnPhone = $this->getSoapClient()->__soapCall('PlayOnPhone', [
                $request,
            ], [], [], $this->outputHeaders));
        
            return $resultPlayOnPhone;
