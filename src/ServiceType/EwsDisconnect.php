...
class EwsDisconnect extends SoapClientBase
{
     ...
     * @param string $actor
     * @return \ServiceType\EwsDisconnect
     */
     ...
     * @param \StructType\EwsDisconnectPhoneCallType $request
     * @return \StructType\EwsDisconnectPhoneCallResponseMessageType|bool
     */
    public function DisconnectPhoneCall(\StructType\EwsDisconnectPhoneCallType $request)
    {
        try {
            $this->setResult($resultDisconnectPhoneCall = $this->getSoapClient()->__soapCall('DisconnectPhoneCall', [
                $request,
            ], [], [], $this->outputHeaders));
        
            return $resultDisconnectPhoneCall;
     ...
     * @return \StructType\EwsDisconnectPhoneCallResponseMessageType
     */
