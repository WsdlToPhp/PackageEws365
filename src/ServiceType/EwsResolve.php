...
class EwsResolve extends SoapClientBase
{
     ...
     * @param \Ews\StructType\EwsResolveNamesType $request
     * @return \Ews\StructType\EwsResolveNamesResponseType|bool
     */
    public function ResolveNames(\Ews\StructType\EwsResolveNamesType $request)
    {
        try {
            $this->setResult($this->getSoapClient()->__soapCall('ResolveNames', array(
                $request,
     ...
     * @return \Ews\StructType\EwsResolveNamesResponseType
     */
