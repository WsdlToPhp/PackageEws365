...
class EwsUpload extends SoapClientBase
{
     ...
     * @param \Ews\StructType\EwsUploadItemsType $request
     * @return \Ews\StructType\EwsUploadItemsResponseType|bool
     */
    public function UploadItems(\Ews\StructType\EwsUploadItemsType $request)
    {
        try {
            $this->setResult($this->getSoapClient()->__soapCall('UploadItems', array(
                $request,
     ...
     * @return \Ews\StructType\EwsUploadItemsResponseType
     */
