 ...
 */
class EwsUpload extends SoapClientBase
{
    /**
     ...
     * @param \StructType\EwsUploadItemsType $request
     * @return \StructType\EwsUploadItemsResponseType|bool
     */
    public function UploadItems(\StructType\EwsUploadItemsType $request)
    {
        try {
            $this->setResult($resultUploadItems = $this->getSoapClient()->__soapCall('UploadItems', [
                $request,
            ], [], [], $this->outputHeaders));
        
            return $resultUploadItems;
     ...
     * @return \StructType\EwsUploadItemsResponseType
     */
