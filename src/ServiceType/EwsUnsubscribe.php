...
class EwsUnsubscribe extends SoapClientBase
{
     ...
     * @param \Ews\StructType\EwsUnsubscribeType $request
     * @return \Ews\StructType\EwsUnsubscribeResponseType|bool
     */
    public function Unsubscribe(\Ews\StructType\EwsUnsubscribeType $request)
    {
        try {
            $this->setResult(self::getSoapClient()->Unsubscribe($request));
