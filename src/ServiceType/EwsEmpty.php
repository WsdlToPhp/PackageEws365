...
/**
 * This class stands for Empty ServiceType
 * @package Ews
 * @subpackage Services
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class EwsEmpty extends SoapClientBase
{
    /**
     ...
     * @param \StructType\EwsEmptyFolderType $request
     * @return \StructType\EwsEmptyFolderResponseType|bool
     */
    public function EmptyFolder(\StructType\EwsEmptyFolderType $request)
    {
        try {
            $this->setResult($resultEmptyFolder = $this->getSoapClient()->__soapCall('EmptyFolder', [
                $request,
            ], [], [], $this->outputHeaders));
        
            return $resultEmptyFolder;
     ...
     * @return \StructType\EwsEmptyFolderResponseType
     */
