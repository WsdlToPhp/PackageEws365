 ...
 * @release 1.0.0
 */
class EwsArrayOfRealItemsType extends AbstractStructBase
{
    /**
     * The Item
     ...
     * @uses EwsArrayOfRealItemsType::setMessage()
     * @uses EwsArrayOfRealItemsType::setCalendarItem()
     * @uses EwsArrayOfRealItemsType::setContact()
     * @uses EwsArrayOfRealItemsType::setDistributionList()
     * @uses EwsArrayOfRealItemsType::setMeetingMessage()
     * @uses EwsArrayOfRealItemsType::setMeetingRequest()
     * @uses EwsArrayOfRealItemsType::setMeetingResponse()
     * @uses EwsArrayOfRealItemsType::setMeetingCancellation()
     * @uses EwsArrayOfRealItemsType::setTask()
     * @uses EwsArrayOfRealItemsType::setPostItem()
     * @uses EwsArrayOfRealItemsType::setRoleMember()
     * @uses EwsArrayOfRealItemsType::setNetwork()
