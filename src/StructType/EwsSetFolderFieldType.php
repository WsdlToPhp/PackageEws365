...
/**
 * This class stands for SetFolderFieldType StructType
 * @package Ews
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class EwsSetFolderFieldType extends EwsFolderChangeDescriptionType
{
    /**
     * The Folder
    ...
    public $TasksFolder;
    /**
     * Constructor method for SetFolderFieldType
     * @uses EwsSetFolderFieldType::setFolder()
     * @uses EwsSetFolderFieldType::setCalendarFolder()
     * @uses EwsSetFolderFieldType::setContactsFolder()
     * @uses EwsSetFolderFieldType::setSearchFolder()
     * @uses EwsSetFolderFieldType::setTasksFolder()
     ...
     * Set Folder value
     * @param \Ews\StructType\EwsFolderType $folder
     * @return \Ews\StructType\EwsSetFolderFieldType
     */
