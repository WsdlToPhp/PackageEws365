...
/**
 * This class stands for ArrayOfFoldersType StructType
 * @package Ews
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class EwsArrayOfFoldersType extends AbstractStructBase
{
    /**
     * The Folder
    ...
    public $TasksFolder;
    /**
     * Constructor method for ArrayOfFoldersType
     * @uses EwsArrayOfFoldersType::setFolder()
     * @uses EwsArrayOfFoldersType::setCalendarFolder()
     * @uses EwsArrayOfFoldersType::setContactsFolder()
     * @uses EwsArrayOfFoldersType::setSearchFolder()
     * @uses EwsArrayOfFoldersType::setTasksFolder()
     ...
     * @param \Ews\StructType\EwsFolderType $folder
     * @return \Ews\StructType\EwsArrayOfFoldersType
     */
